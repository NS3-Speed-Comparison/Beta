...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  pos.Set ("X", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=" + std::to_string(areaSizeX) + "]"));
  pos.Set ("Y", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=" + std::to_string(areaSizeY) + "]"));
