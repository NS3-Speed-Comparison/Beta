...
int areaSize = 500;                     // Size of the area in meters
int areaSizeX = areaSize;                    
int areaSizeY = areaSize;
...
std::string PacketSize = "64";          // Size of the packets being sent (64, 128, 256)
...
RoutingExperiment::CommandSetup (int argc, char **argv)
{
  ...
  cmd.AddValue ("areaSize", "Size of the simulation area", m_areaSize); // Added this
  cmd.Parse (argc, argv);
...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  pos.Set ("X", StringValue (
                    "ns3::UniformRandomVariable[Min=0.0|Max=" + std::to_string (m_areaSize) + "]"));
